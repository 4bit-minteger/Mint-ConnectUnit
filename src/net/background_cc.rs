...
pub const DEFAULT_BURST_CAP_BYTES: u64 = 24_000;
pub const DEFAULT_GAIN: f64 = 0.1;
pub const DEFAULT_MIN_DECREASE_FACTOR: f64 = 0.9;
pub const DEFAULT_ADDITIVE_INCREASE_BPS: f64 = 32_000.0;
...
pub const DEFAULT_INITIAL_RATE_BPS: f64 = 4_000_000.0;
pub const DEFAULT_LOSS_MD: f64 = 0.9;
pub const DEFAULT_HOL_ESCAPE_MS: u32 = 8;
pub const DEFAULT_TARGET_QUEUE_DELAY_MS: u32 = 20;
